...
function initListeners() {
    chrome.runtime.onMessage.addListener(
        (message: Message, sender: chrome.runtime.MessageSender, sendResponse: (response?: any) => void) => {
            ...
            console.log("Background received message", MessageType[message.type], message);
            ...
            switch (message.type) {
                ...
                case MessageType.REQUEST_SETTINGS:
                    ...
                    break;
                case MessageType.REQUEST_RULES:
                    sendResponse(getRulesSnapshot());
                    break;
    ...
    //open config page as default behavior of clicking the action button
    browserAction?.onClicked.addListener(openConfig);
}
